...
namespace Com.Gosol.VHTT.Models.DanhMuc
{
    public class DanhMucCoQuanDonViModel
    {
        ...
        public int? HinhThuVHTThamCong { get; set; }
    ...
    public class DanhMuVHTToQuanPar : DanhMucCoQuanDonViModel
    {
        public List<DanhMucCoQuanDonViModel> Children { get; set; }
        public List<DanhMuVHTToQuanPar> Parent { get; set; }
        public DanhMuVHTToQuanPar()
        {

        }
        public DanhMuVHTToQuanPar(List<DanhMucCoQuanDonViModel> Children, List<DanhMuVHTToQuanPar> Parent)
        {
           this.Children = Children;
            this.Parent = Parent;
        }
    ...
    public class DanhMuVHTToQuanDonViPartialModel : DanhMucCoQuanDonViModel
    {
        public List<DanhMuVHTToQuanDonViPartialModel> Children { get; set; }
        public DanhMuVHTToQuanDonViPartialModel(
            int CoQuanID, string TenCoQuan, int CoQuanChaID,
            string MaCQ, List<DanhMuVHTToQuanDonViPartialModel> Children)
        {
            this.CoQuanID = CoQuanID;
            this.TenCoQuan = TenCoQuan;
            this.CoQuanChaID = CoQuanChaID;
