...
namespace Com.Gosol.VHTT.Models.DanhMuc
{
    ...
    public class DanhMuVHTToQuanMODPar : DanhMucCoQuanDonViMOD
    {
        public List<DanhMucCoQuanDonViMOD> Children1 { get; set; }
        public List<DanhMuVHTToQuanPar> Parent1 { get; set; }
        public DanhMuVHTToQuanMODPar()
        {

        }
        public DanhMuVHTToQuanMODPar(List<DanhMucCoQuanDonViMOD> Children, List<DanhMuVHTToQuanPar> Parent)
        {
    ...
    public class DanhMuVHTToQuanDonViMODModel : DanhMucCoQuanDonViMOD
    {
        public List<DanhMuVHTToQuanDonViPartialModel> Children1 { get; set; }
        public DanhMuVHTToQuanDonViMODModel(
            int CoQuanID, string TenCoQuan, int CoQuanChaID,
            string MaCQ, List<DanhMuVHTToQuanDonViMODModel> Children)
        {
            this.CoQuanID = CoQuanID;
            this.TenCoQuan = TenCoQuan;
            this.CoQuanChaID = CoQuanChaID;
